...
// Processes actions given as morse input. Does everything from playing tones to drawing the input
// on the screen. Returns a valid MorseCharacter (not zero) when a character finishes being input
